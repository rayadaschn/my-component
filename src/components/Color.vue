<template>
  <div class="box">
    <div class="icon" @click="toggleShow">
      <svg
    ...
    <div class="pen-size" v-show="show">
      <span class="color-tips">颜色 {{ currentTools.color }}</span>
      <input type="color" v-model="currentTools.color" />
    </div>
  </div>
</template>
...
.pen-size {
  ...
  align-items: center;
  border: 2px solid rgb(162, 148, 148);
  background: rgb(225, 236, 225);
  border-radius: 6px;
